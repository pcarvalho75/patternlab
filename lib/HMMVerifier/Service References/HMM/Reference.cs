...
namespace HMMVerifier.HMM {
    ...
    public interface IHMM {
        ...
        HMMVerifier.HMM.HMMResult[] Scan(string fastaSequence);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHMM/Scan", ReplyAction="http://tempuri.org/IHMM/ScanResponse")]
        System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> ScanAsync(string fastaSequence);
        ...
        HMMVerifier.HMM.HMMResult[] Scans(System.Collections.Generic.Dictionary<string, string> fastaSequences);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHMM/Scans", ReplyAction="http://tempuri.org/IHMM/ScansResponse")]
        System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> ScansAsync(System.Collections.Generic.Dictionary<string, string> fastaSequences);
        ...
        HMMVerifier.HMM.HMMResult[] FilteredScans(System.Collections.Generic.Dictionary<string, string> fastaSequences, double iEvalue, double qEValue);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHMM/FilteredScans", ReplyAction="http://tempuri.org/IHMM/FilteredScansResponse")]
        System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> FilteredScansAsync(System.Collections.Generic.Dictionary<string, string> fastaSequences, double iEvalue, double qEValue);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IHMMChannel : HMMVerifier.HMM.IHMM, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HMMClient : System.ServiceModel.ClientBase<HMMVerifier.HMM.IHMM>, HMMVerifier.HMM.IHMM {
        ...
        public HMMVerifier.HMM.HMMResult[] Scan(string fastaSequence) {
            return base.Channel.Scan(fastaSequence);
        }
        
        public System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> ScanAsync(string fastaSequence) {
            return base.Channel.ScanAsync(fastaSequence);
        }
        
        public HMMVerifier.HMM.HMMResult[] Scans(System.Collections.Generic.Dictionary<string, string> fastaSequences) {
            return base.Channel.Scans(fastaSequences);
        }
        
        public System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> ScansAsync(System.Collections.Generic.Dictionary<string, string> fastaSequences) {
            return base.Channel.ScansAsync(fastaSequences);
        }
        
        public HMMVerifier.HMM.HMMResult[] FilteredScans(System.Collections.Generic.Dictionary<string, string> fastaSequences, double iEvalue, double qEValue) {
            return base.Channel.FilteredScans(fastaSequences, iEvalue, qEValue);
        }
        
        public System.Threading.Tasks.Task<HMMVerifier.HMM.HMMResult[]> FilteredScansAsync(System.Collections.Generic.Dictionary<string, string> fastaSequences, double iEvalue, double qEValue) {
