...
namespace PatternTools.ArrowHeads
{
    ...
    public abstract class ArrowLineBase : Shape
    {
        ...
        protected override Geometry DefiningGeometry
        {
            get
            {
                ...
                if (count > 0)
                {
                    ...
                    {
                        System.Windows.Point pt1 = pathfigLine.StartPoint;
                        System.Windows.Point pt2 = polysegLine.Points[0];
                    ...
                    {
                        System.Windows.Point pt1 = count == 1 ? pathfigLine.StartPoint :
                                                 polysegLine.Points[count - 2];
                        System.Windows.Point pt2 = polysegLine.Points[count - 1];
        ...
        PathFigure CalculateArrow(PathFigure pathfig, System.Windows.Point pt1, System.Windows.Point pt2)
        {
