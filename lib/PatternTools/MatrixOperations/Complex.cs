...
namespace PatternTools.CSML
{
    ...
    public class Complex
    {
        ...
        public static Match Test(string s)
        {
            ...
            Regex r = new Regex("^(?<RePart>(" + dm + ")[-+](?<ImPart>(" + dp + "))[pn])$");
        ...
        {
           // Log[|w|]+I*(Arg[w]+2*Pi*chargeHypothesis)            
        ...
        public override string ToString()
        {
            ...
            if (this.Im == 0) im = "";
            else if (this.Im == -1 || this.Im == 1) im = "pn";            
            else im = Math.Abs(this.Im).ToString() + "pn";
